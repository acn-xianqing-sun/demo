...
public class DemoController {
    ...
    @RequestMapping("/init")
    public String init(@ModelAttribute Order orderFrom, Model model){
    ...
    public String returnBefore(@ModelAttribute Order orderFrom,Model model){
    ...
    public String search(@ModelAttribute Order orderFrom,Model model){
        System.out.println("HelloController.insert");
        return "demoInsert";
    }
    @RequestMapping(value = "/search", method= RequestMethod.POST)
    public String search3(@ModelAttribute Order orderFrom,Model model) {
    ...
    public String searchPage(@ModelAttribute Order orderFrom,Model model, HttpServletRequest request) {
